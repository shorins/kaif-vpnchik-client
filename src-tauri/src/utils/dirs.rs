...
pub static APP_ID: &str = "com.kaifvpnchik.client";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "kaif-vpnchik-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "com.kaifvpnchik.client.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "kaif-vpnchik-backup-dev";
